...
void initializeBoard(int chessboard[ROWS][COLUMNS],int initialRow, int initialColumn){
...
void printBoard(int chessboard[ROWS][COLUMNS]){ //,int rowSize, int columnSize){
